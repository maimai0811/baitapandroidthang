...
public class ChiTieuFragment extends Fragment {
    ...
    //BarChart
    private PieChart bcChiTieu;
    private PieData barDataChiTieu;
    private PieDataSet barDataSetChiTieu;
    private ArrayList<PieEntry> giaTriChiTieu;
    ...
    private PieChart bcThuNhap;
    private PieData barDataThuNhap;
    private PieDataSet barDataSetThuNhap;
    private ArrayList<PieEntry> giaTriThuNhap;
    ...
    private void duLieuThuNhap() {
        ...
        for (int i = 0; i < danhMucs.size(); i++) {
            ...
            if (sum > 0) {
                giaTriThuNhap.add(new PieEntry(sum, danhMuc.getTenDanhMuc()));
        ...
        PieDataSet thuchi = new PieDataSet(giaTriThuNhap, "");
        thuchi.setColors(colors);
        bcThuNhap.animateX(200);
        ...
        ValueFormatter formatter = new ValueFormatter() {
            ...
            public String getFormattedValue(float value) {
                return mFormat.format((value/tongThu)*100) + " %";
            }
        };
        pieData.setValueFormatter(formatter);
        pieData.setDrawValues(true);
        Legend legend = bcThuNhap.getLegend();
        legend.setVerticalAlignment(Legend.LegendVerticalAlignment.BOTTOM);
        legend.setHorizontalAlignment(Legend.LegendHorizontalAlignment.CENTER);
        legend.setOrientation(Legend.LegendOrientation.HORIZONTAL);
        legend.setDrawInside(false);
        legend.setEnabled(true);
        bcThuNhap.setData(pieData);
        bcThuNhap.invalidate();
        bcThuNhap.setDrawSliceText(false);
...
//        }
        for (int i = 0; i < danhMucs.size(); i++) {
            ...
            if (sum > 0) {
                giaTriChiTieu.add(new PieEntry(sum, danhMuc.getTenDanhMuc()));
        ...
        PieDataSet thuchi = new PieDataSet(giaTriChiTieu, "");
        thuchi.setColors(colors);
        bcChiTieu.animateX(200);
        ...
        ValueFormatter formatter = new ValueFormatter() {
            @Override
            public String getFormattedValue(float value) {
                return mFormat.format((value/tongChi)*100) + " %";
            }
        };
        pieData.setValueFormatter(formatter);
        pieData.setDrawValues(true);
        Legend legend = bcChiTieu.getLegend();
        legend.setVerticalAlignment(Legend.LegendVerticalAlignment.BOTTOM);
        legend.setHorizontalAlignment(Legend.LegendHorizontalAlignment.CENTER);
        legend.setOrientation(Legend.LegendOrientation.HORIZONTAL);
        legend.setDrawInside(false);
        legend.setEnabled(true);
        bcChiTieu.setData(pieData);
        bcChiTieu.invalidate();
        bcChiTieu.setDrawSliceText(false);
